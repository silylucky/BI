# Per-Type Truth: `bar-group-stack`

| 字段 | 值 |
|------|-----|
| chartType | `bar-group-stack` |
| 日期 | 2026-08-05 |
| 判定 | **REAL** |
| 专属检查 | 标准 L3/L2/L1 门禁 |
...
| 步 | 项 | 状态 | 证据 |
|----|-----|------|------|
| 1 | DE 槽位审计 | ✅ | `getDeAxisBlueprint("bar-group-stack")` · `ChartDataSlots.deParity` |
| 2 | L3 输入 | ✅ | `chartFieldSlots.test.ts` T-INSP-DE-golden |
| 3 | L2 编码 | ✅ | `perType/bar-group-stack.parity.test.ts` · `chartCatalogData.test.ts` |
