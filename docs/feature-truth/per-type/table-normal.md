...
| 步 | 项 | 状态 | 证据 |
|----|-----|------|------|
| 1 | DE 槽位审计 | ✅ | `getDeAxisBlueprint("table-normal")` · `ChartDataSlots.deParity` |
| 2 | L3 输入 | ✅ | `chartFieldSlots.test.ts` T-INSP-DE-golden |
| 3 | L2 编码 | ✅ | `perType/table-normal.parity.test.ts` · `chartCatalogData.test.ts` |
